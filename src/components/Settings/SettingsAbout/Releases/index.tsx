...
const REPO_RELEASE_API =
  'https://api.github.com/repos/cmaquerre/agregarr_test/releases?per_page=20';
...
const Release = ({ currentVersion, release, isLatest }: ReleaseProps) => {
  ...
  return (
    <div className="flex w-full flex-col space-y-3 rounded-md bg-stone-800 px-4 py-2 shadow-md ring-1 ring-gray-700 sm:flex-row sm:space-y-0 sm:space-x-3">
      <Transition
        as={Fragment}
